...
// functions for handling programs
...
app.get('/Contact', function(req, res) {
    ...
    res.render('Contact_US', { csrf: 'CSRF token here' });
});
//render the register
...
*/
/**
 * Process the linkes of social network
 * 
 */
//process the facebook social
app.get('/facebook', function(req, res) {
    res.render('');
});
//process the twiter social
app.get('/twiter', function(req, res) {
    res.render('_');
});
//process telegram social
app.get('/telegram', function(req, res) {
    res.render('');
});
//process the whatsapp social
app.get('/whatsapp', function(req, res) {
    res.render('');
});
//process the github social
app.get('/github', function(req, res) {
    res.render('_');
});
//process instagram social
app.get('/instagram', function(req, res) {
    res.render('');
});
//process the linkedin social
app.get('/linkedin', function(req, res) {
    res.render('');
});

//end of social processing
/**
 * Processing the linkes to samples of our work programs
 */


//process the sample report
app.get('/sample-report', function(req, res) {
    res.render('');
});
//process the sample ios-android application
app.get('/sample-application', function(req, res) {
    res.render('_');
});
//process samples of web site and application
app.get('/sample-we-app', function(req, res) {
    res.render('');
});
//process the desktop samples link
app.get('/sample-desktop', function(req, res) {
    res.render('');
});
//process the client server application
app.get('/sample-client-server', function(req, res) {
    res.render('');
});
//process the NS2 projects
app.get('/sample-ns2', function(req, res) {
    res.render('_');
});
//process  samples of data science amd machine learning 
app.get('/sample-ds-ml', function(req, res) {
    res.render('');
});
//process the samples of course project
app.get('/sample-courses-project', function(req, res) {
    res.render('');
});
